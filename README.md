...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 51c50c8e-2d08-4b5f-a7a8-5788e01255a7
```

> `51c50c8e-2d08-4b5f-a7a8-5788e01255a7` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the [PreimerClinc](./PreimerClinc) project directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disable it.
